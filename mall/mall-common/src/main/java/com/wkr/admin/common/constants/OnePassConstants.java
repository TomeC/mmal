package com.wkr.admin.common.constants;
...
public class OnePassConstants {
    ...
    // 一号通请求地址
    public static final String ONE_PASS_API_URL = "https://sms.mall.net/api/";// 正式环境
//    public static final String ONE_PASS_API_URL = "http://plat.mall.net/api/";// 测试环境
