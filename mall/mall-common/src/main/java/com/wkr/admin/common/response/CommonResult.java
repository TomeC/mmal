...
import com.wkr.admin.common.exception.ExceptionCodeEnum;
import com.wkr.admin.common.exception.ExceptionHandler;
...
public class CommonResult<T> {
    ...
    public boolean checkIfFail() {
        return code != ExceptionCodeEnum.SUCCESS.getCode();
    }
