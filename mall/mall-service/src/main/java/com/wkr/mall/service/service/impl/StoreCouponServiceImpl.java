...
import com.wkr.admin.common.request.SearchAndPageRequest;
import com.wkr.admin.common.constants.Constants;
import com.wkr.admin.common.constants.CouponConstants;
...
import com.wkr.admin.common.model.category.Category;
import com.wkr.admin.common.model.coupon.StoreCoupon;
import com.wkr.admin.common.model.coupon.StoreCouponUser;
import com.wkr.admin.common.request.StoreCouponRequest;
import com.wkr.admin.common.request.StoreCouponSearchRequest;
import com.wkr.admin.common.response.StoreCouponFrontResponse;
import com.wkr.admin.common.response.StoreCouponInfoResponse;
import com.wkr.admin.common.model.product.StoreProduct;
import com.wkr.mall.service.service.*;
import com.wkr.mall.service.dao.StoreCouponDao;
    ...
    */
    ...
    public Boolean delete(Integer id) {
        ...
        if (ObjectUtil.isNull(coupon) || coupon.getIsDel()) {
            throw new MallException("优惠券不存在");
        }
    ...
    public Boolean updateStatus(Integer id, Boolean status) {
        ...
        if (coupon.getStatus().equals(status)) {
            throw new MallException("优惠券状态无需变更");
        }
        StoreCoupon storeCoupon = new StoreCoupon();
    ...
    private void getPrimaryKeySql(LambdaQueryWrapper<StoreCoupon> lambdaQueryWrapper, String productIdStr) {
        ...
        lambdaQueryWrapper.and(i -> i.and(
                ...
                .or(p -> p.eq(StoreCoupon::getUseType , 2).apply(MallUtil.getFindInSetSql("primary_key", productIdStr)))
                .or(c -> c.eq(StoreCoupon::getUseType , 3).apply(MallUtil.getFindInSetSql("primary_key", (ArrayList<Integer>) categoryIdList)))
        ));
    }
}
