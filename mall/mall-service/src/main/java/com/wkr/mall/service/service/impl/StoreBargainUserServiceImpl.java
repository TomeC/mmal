...
import com.wkr.admin.common.request.BargainFrontRequest;
...
import com.wkr.admin.common.response.BargainRecordResponse;
import com.wkr.admin.common.response.BargainUserInfoResponse;
...
import com.wkr.admin.common.model.bargain.StoreBargainUserHelp;
import com.wkr.admin.common.request.StoreBargainUserSearchRequest;
import com.wkr.admin.common.response.StoreBargainUserResponse;
import com.wkr.admin.common.model.order.StoreOrder;
import com.wkr.admin.common.model.user.User;
import com.wkr.mall.service.dao.StoreBargainUserDao;
    ...
    */
    ...
    private BargainUserInfoResponse otherBargainActivity(BargainFrontRequest bargainFrontRequest) {
        ...
        if (bargainUser.getUid().equals(user.getUid())) {// 自己的砍价活动
            ...
            percent =  MallUtil.percentInstanceIntVal(alreadyPrice, alreadyPrice.add(surplusPrice));
            infoResponse.setBargainStatus(bargainStatus);
            infoResponse.setAlreadyPrice(alreadyPrice);
            infoResponse.setSurplusPrice(surplusPrice);
            infoResponse.setBargainPercent(percent);
    ...
    private BargainUserInfoResponse oneselfBargainActivity(BargainFrontRequest bargainFrontRequest) {
        ...
        if (storeBargainUser.getStatus().equals(2)) {// 活动结束，砍价未完成
            throw new MallException("未在活动期内完成砍价");
        }
        // 参与过该商品的砍价
