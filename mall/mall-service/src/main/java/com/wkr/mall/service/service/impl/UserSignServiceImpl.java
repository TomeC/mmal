...
import com.wkr.admin.common.model.user.UserExperienceRecord;
...
import com.wkr.admin.common.constants.ExperienceRecordConstants;
...
import com.wkr.mall.service.dao.UserSignDao;
...
public class UserSignServiceImpl extends ServiceImpl<UserSignDao, UserSign> implements UserSignService {
    ...
    public SystemGroupDataSignConfigVo sign() {
        ...
        if (CollUtil.isEmpty(config)) {
            throw new MallException("签到配置不存在，请在管理端配置签到数据");
        }
