...
import com.wkr.admin.common.request.SystemConfigAdminRequest;
...
import com.wkr.admin.common.vo.ExpressSheetVo;
import com.wkr.admin.common.model.system.SystemConfig;
import com.wkr.mall.service.dao.SystemConfigDao;
...
public class SystemConfigServiceImpl extends ServiceImpl<SystemConfigDao, SystemConfig> implements SystemConfigService {
    ...
    private void setRedisByVoList() {
        ...
        if (size > 0 || !mallConfig.isAsyncConfig()) {
            return;
        }
