...
import com.wkr.admin.common.request.ExpressSearchRequest;
import com.wkr.admin.common.request.ExpressUpdateRequest;
import com.wkr.admin.common.request.ExpressUpdateShowRequest;
import com.wkr.mall.service.dao.ExpressDao;
...
public class ExpressServiceImpl extends ServiceImpl<ExpressDao, Express> implements ExpressService {
    ...
    public Boolean updateExpress(ExpressUpdateRequest expressRequest) {
        ...
        if (ObjectUtil.isNull(temp)) throw new MallException("快递公司不存在!");
