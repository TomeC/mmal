...
import com.wkr.admin.common.response.StoreOrderDetailResponse;
import com.wkr.admin.common.response.StoreProductResponse;
import com.github.pagehelper.PageInfo;
import com.wkr.admin.common.utils.MallUtil;
import com.wkr.admin.common.utils.DateUtil;
import com.wkr.admin.common.utils.ExportUtil;
import com.wkr.admin.common.response.StoreBargainResponse;
import com.wkr.admin.common.response.StoreCombinationResponse;
import com.wkr.admin.common.vo.BargainProductExcelVo;
import com.wkr.admin.common.vo.CombinationProductExcelVo;
import com.wkr.admin.common.vo.OrderExcelVo;
import com.wkr.admin.common.vo.ProductExcelVo;
...
public class ExcelServiceImpl implements ExcelService {
    ...
    public String exportBargainProduct(StoreBargainSearchRequest request) {
        ...
        // 上传设置
        ExportUtil.setUpload(mallConfig.getImagePath(), Constants.UPLOAD_MODEL_PATH_EXCEL, Constants.UPLOAD_TYPE_FILE);
    ...
    public String exportOrder(StoreOrderSearchRequest request) {
        ...
        // 文件名
        String fileName = "订单导出_".concat(DateUtil.nowDateTime(Constants.DATE_TIME_FORMAT_NUM)).concat(MallUtil.randomCount(111111111, 999999999).toString()).concat(".xlsx");
