...
import com.wkr.admin.common.request.UserCollectAllRequest;
import com.wkr.admin.common.request.UserCollectRequest;
import com.wkr.admin.common.response.UserRelationResponse;
import com.github.pagehelper.PageHelper;
import com.wkr.admin.common.utils.MallUtil;
import com.wkr.admin.common.model.product.StoreProductRelation;
import com.wkr.mall.service.dao.StoreProductRelationDao;
import com.wkr.mall.service.service.StoreProductRelationService;
...
public class StoreProductRelationServiceImpl extends ServiceImpl<StoreProductRelationDao, StoreProductRelation>
    ...
    public Boolean delete(String requestJson) {
        ...
        if (StrUtil.isBlank(jsonObject.getString("ids"))) {
            throw new MallException("收藏id不能为空");
        }
        List<Integer> idList = MallUtil.stringToArray(jsonObject.getString("ids"));
