...
import com.wkr.admin.common.model.system.SystemRole;
import com.wkr.admin.common.model.system.SystemRoleMenu;
import com.wkr.admin.common.request.PageParamRequest;
import com.wkr.admin.common.request.SystemRoleRequest;
import com.wkr.admin.common.request.SystemRoleSearchRequest;
import com.wkr.admin.common.response.RoleInfoResponse;
...
import com.wkr.admin.common.vo.MenuCheckTree;
import com.wkr.admin.common.vo.MenuCheckVo;
import com.github.pagehelper.PageHelper;
import com.wkr.mall.service.dao.SystemRoleDao;
import com.wkr.mall.service.service.CategoryService;
import com.wkr.mall.service.service.SystemMenuService;
import com.wkr.mall.service.service.SystemRoleMenuService;
import com.wkr.mall.service.service.SystemRoleService;
    ...
    */
    ...
    public Boolean add(SystemRoleRequest systemRoleRequest) {
        if (existName(systemRoleRequest.getRoleName(), null)) {
            throw new MallException("角色名称重复");
        }
