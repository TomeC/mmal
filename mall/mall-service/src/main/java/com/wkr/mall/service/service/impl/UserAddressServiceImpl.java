...
import com.wkr.admin.common.request.UserAddressRequest;
import com.github.pagehelper.PageHelper;
import com.wkr.admin.common.model.system.SystemCity;
import com.wkr.admin.common.model.user.UserAddress;
import com.wkr.mall.service.dao.UserAddressDao;
import com.wkr.mall.service.service.SystemCityService;
import com.wkr.mall.service.service.UserAddressService;
    ...
    */
    ...
    public UserAddress create(UserAddressRequest request) {
        ...
        if (request.getAddress().getCityId() == 0 && StringUtils.isBlank(request.getAddress().getCity())) {
            throw new MallException("请选择正确城市数据");
        }
        if (StringUtils.isNotBlank(request.getAddress().getCity()) && request.getAddress().getCityId() == 0) {
            ...
            if (ObjectUtil.isNull(currentCity)) throw new MallException("当前城市未找到！");
