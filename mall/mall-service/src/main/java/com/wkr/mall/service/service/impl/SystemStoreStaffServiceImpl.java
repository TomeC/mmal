...
import com.wkr.admin.common.request.SystemStoreStaffRequest;
import com.wkr.admin.common.response.SystemStoreStaffResponse;
import com.github.pagehelper.Page;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.wkr.admin.common.model.system.SystemStore;
import com.wkr.admin.common.model.system.SystemStoreStaff;
import com.wkr.admin.common.model.user.User;
import com.wkr.mall.service.dao.SystemStoreStaffDao;
import com.wkr.mall.service.service.SystemStoreService;
import com.wkr.mall.service.service.SystemStoreStaffService;
...
public class SystemStoreStaffServiceImpl extends ServiceImpl<SystemStoreStaffDao, SystemStoreStaff> implements SystemStoreStaffService {
    ...
    public Boolean saveUnique(SystemStoreStaffRequest request) {
        ...
        if (CollUtil.isNotEmpty(existStaffs) && existStaffs.size() > 0) throw new MallException(Constants.RESULT_VERIFICATION_USER_EXIST);
    ...
    public Boolean updateStatus(Integer id, Integer status) {
        ...
        if (ObjectUtil.isNull(systemStoreStaff)) {
            throw new MallException("核销员不存在");
        }
