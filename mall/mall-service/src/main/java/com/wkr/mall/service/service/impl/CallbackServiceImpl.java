...
import com.wkr.admin.common.constants.TaskConstants;
...
import com.wkr.admin.common.vo.AttachVo;
import com.wkr.admin.common.vo.CallbackVo;
...
public class CallbackServiceImpl implements CallbackService {
        ...
        try{
            ...
            if (Constants.SERVICE_PAY_TYPE_ORDER.equals(attachVo.getType())) {
                ...
                if (ObjectUtil.isNull(wechatPayInfo)) {
                    ...
                    throw new MallException("wechat pay error : 微信订单信息不存在==》" + callbackVo.getOutTradeNo());
                }
    ...
    private String getSignKey(String appid) {
        ...
        if (StrUtil.isBlank(publicAppid) && StrUtil.isBlank(miniAppid) && StrUtil.isBlank(appAppid)) {
            throw new MallException("pay_weixin_appid或pay_routine_appid不能都为空");
        }
