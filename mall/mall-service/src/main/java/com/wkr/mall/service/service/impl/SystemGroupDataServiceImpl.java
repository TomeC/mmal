...
import com.wkr.admin.common.request.SystemFormItemCheckRequest;
import com.wkr.admin.common.request.SystemGroupDataRequest;
import com.wkr.admin.common.request.SystemGroupDataSearchRequest;
import com.github.pagehelper.PageHelper;
import com.wkr.admin.common.utils.MallUtil;
import com.wkr.admin.common.model.system.SystemGroupData;
import com.wkr.mall.service.dao.SystemGroupDataDao;
import com.wkr.mall.service.service.SystemAttachmentService;
import com.wkr.mall.service.service.SystemFormTempService;
    ...
    */
    ...
    public <T> List<T> getListByGid(Integer gid, Class<T> cls) {
        ...
        for (SystemGroupData systemGroupData : list) {
            ...
            List<SystemFormItemCheckRequest> systemFormItemCheckRequestList = MallUtil.jsonToListClass(jsonObject.getString("fields"), SystemFormItemCheckRequest.class);
