package com.wkr.mall.service.util;


import cn.hutool.core.util.ObjectUtil;
import com.alibaba.fastjson.JSON;
import com.wkr.admin.common.constants.YlyConstants;
...
import com.wkr.admin.common.response.YlyAccessTokenResponse;
import com.wkr.admin.common.utils.RedisUtil;
import com.wkr.mall.service.service.SystemConfigService;
import com.wkr.mall.service.util.yly.RequestMethod;
...
public class YlyUtil {
    ...
    public void instant() {
        ...
        try {
            ...
            if(StringUtils.isBlank(client_id) || StringUtils.isBlank(client_secret)
                ...
                throw new MallException("易联云配置数据不完整");
            }
    ...
    public void ylyVoice() throws Exception {
        ...
        RequestMethod.getInstance().printerSetVoice(
                ...
                machine_code,"[\"mall 来新单了\",9,0]","false",
                "0","ORDER xxx");
        logger.info("设置语音成功");
    }
...
//        ylyPrintRequest.setBusinessName("mall Java Order");
