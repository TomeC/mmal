...
import com.wkr.admin.common.model.product.StoreProductReply;
...
import com.wkr.admin.common.request.StoreProductReplyAddRequest;
import com.wkr.admin.common.request.StoreProductReplyCommentRequest;
import com.wkr.admin.common.request.StoreProductReplySearchRequest;
import com.wkr.admin.common.response.ProductDetailReplyResponse;
import com.wkr.admin.common.response.ProductReplyResponse;
import com.wkr.admin.common.response.StoreProductReplyResponse;
...
import com.wkr.admin.common.vo.StoreOrderInfoOldVo;
import com.wkr.admin.common.vo.dateLimitUtilVo;
import com.wkr.mall.service.dao.StoreProductReplyDao;
...
public class StoreProductReplyServiceImpl extends ServiceImpl<StoreProductReplyDao, StoreProductReply>
    ...
    */
    ...
    public Boolean create(StoreProductReplyAddRequest request) {
        ...
        if (!execute) {
            throw new MallException("评价订单失败");
        }
        return execute;
    }
    ...
    public ProductDetailReplyResponse getH5ProductReply(Integer proId) {
        ...
        // 评价图
        productReplyResponse.setPics(MallUtil.stringToArrayStr(storeProductReply.getPics()));
        // 昵称
